...
- `qinn_state_path` per salvare/caricare lo stato Torch del modulo qINN (default: `<output>/qinn_module_state.pt`)
...
- `use_pennylane=true`: percorso quantum con `qml.qnn.TorchLayer` blocchi invertibili PennyLane
